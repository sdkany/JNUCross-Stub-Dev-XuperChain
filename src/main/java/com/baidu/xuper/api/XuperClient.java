...
public class XuperClient {
    ...
    private String chainName = "xuper";//"com/baidu/xuper";
    ...
    public XchainGrpc.XchainBlockingStub getBlockingClient() {
    ...
    public XchainOuterClass.InternalBlock queryBlockByHeight(long height){
        return this.getBlockingClient().
                getBlockByHeight(XchainOuterClass.BlockHeight.newBuilder().
                        setBcname("xuper").
                        setHeight(height).build()).getBlock();
    }

    public BigInteger getBalance(String address, boolean isFrozen){
        return isFrozen? new BigInteger(this.getBalanceDetails(address)[0].getBalance()) : new BigInteger(this.getBalanceDetails(address)[1].getBalance());
    }

    public long getHeight(){
        return this.getBlockchainStatus(chainName).getMeta().getTrunkHeight();
    }
}
